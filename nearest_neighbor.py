...
def main():
    ...
    print("Wine Quality Classification using Nearest Neighbor Classification")
    print("=======================")
    ...
    white_clf = KNeighborsClassifier(n_neighbors=2)
    white_clf.fit(white_train_data, white_train_labels)
    
    print("Training a model for Red Wines...")
    red_clf = KNeighborsClassifier(n_neighbors=2)
